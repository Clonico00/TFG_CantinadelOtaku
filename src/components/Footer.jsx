...
const Footer = ({ handleLinkClick }) => {
  ...
  return (
    <footer className="py-12 w-full rounded-t-lg shadow-md border border-gray-200 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:text-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div className="grid grid-cols-1 gap-4 justify-center ">
            <div className="flex items-center mb-4 justify-center mr-4">
              ...
              <h2
                className="font-extrabold tracking-tight text-2xl whitespace-nowrap"
                style={{
          ...
          <div className="grid grid-cols-1 gap-4">
            <h2
              className="font-extrabold tracking-tight text-xl whitespace-nowrap text-center"
              style={{
                backfaceVisibility: "hidden",
                color: "#1e2447",
              }}
        ...
        <div className="text-center mt-8">
          <p
            className="transition-all duration-400 px-3 py-2 text-md font-extrabold"
            style={{ backfaceVisibility: "hidden", color: "#1e2447" }}
          >
            &copy; 2023 Cantina del Otaku. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
