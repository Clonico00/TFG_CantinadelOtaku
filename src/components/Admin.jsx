...
function Admin() {
  ...
  return (
    <>
      ...
      />
      <div className="flex justify-between items-center px-6 py-4 mt-10 bg-gray-50 border border-gray-200 rounded  custom-margin overflow-x-auto">
        <h2
        ...
        <button
          className="text-white font-bold px-6 py-1 rounded hover:scale-105 transition-all duration-400 "
            ...
            {currentItems.map((articulo) => (
              <tr key={articulo.id} className="hover:bg-gray-50">
                <td className="flex gap-3 px-6 py-4 text-gray-500">
                  ...
                  <div className="mt-2.5 ml-2">{articulo.title}</div>
                </td>
