                ...
                <>
                    {articles.length > 0 ? (
                                ...
                                <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 p-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                    {displayedArticles.map((article) =>
                                        article.data.library.map((item, index) => (
                                            ...
                                            >
                                                <Link
                                                    to={`/libreria/detail/${encodeURIComponent(currentUser.email)}/${encodeURIComponent(item.pdf)}`}
                                                >
                                                    ...
                                                    <div className="mt-1 p-2 flex flex-col">
                                                        <div className="flex justify-between items-end">
                                                            <h2
                                                                className="font-bold"
                                                                style={{ backfaceVisibility: "hidden", color: "#1e2447", fontSize: "1rem" }}
                                                            >
                                                                {item.title}
                                                            </h2>
                                                        </div>
                        ...
                        <div className="pt-16 mb-56">
                            <h2 className="text-center text-xl font-bold" style={{ backfaceVisibility: "hidden", color: "#1e2447" }}>
