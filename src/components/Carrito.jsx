            ...
            <div className=" pt-20 mb-24 overflow-auto">
                ...
                <div className="mx-auto max-w-7xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
                    ...
                    <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
                        ...
                        <div className="mb-2 flex justify-between mt-2 flex-col">
                            <label htmlFor="provincia" className="text-sm font-bold text-gray-900 block mb-2 dark:text-gray-300" style={{backfaceVisibility: 'hidden', color: '#1e2447'}}>
                                Provincia:
                            </label>
                            <div className="relative mb-6">
                                <select name="provincia" id="provincia" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-2 p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required onChange={(e) => {
                                    ...
                                    if (seleccion) {
                                        ...
                                        ciudadesDeProvincia.forEach((ciudad, index) => {
                        ...
                        <div className="mb-2 flex justify-between mt-2 flex-col">
                            <label htmlFor="ciudad" className="text-sm font-bold text-gray-900 block mb-2 dark:text-gray-300" style={{backfaceVisibility: 'hidden', color: '#1e2447'}}>
                                Ciudad:
                            </label>
                            <div className="relative mb-6">
                                <select name="ciudad" id="ciudad" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-2 p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required></select>
                            </div>
                        </div>
