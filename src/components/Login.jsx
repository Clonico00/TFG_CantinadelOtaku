                    ...
                    <div className="w-full p-4 py-5">
                        ...
                        <form className="mt-4" onSubmit={handleLogin}>
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="text-sm ml-3">
                                    <a href="/" className=" text-blue-700 hover:underline ml-auto dark:text-blue-500">¿Te
                                        has olvidado de la contraseña?</a>
                                </div>
                            </div>
                            <button type="submit"
                            ...
                            <div className="text-sm font-medium text-gray-500 dark:text-gray-300 mt-4">
                                ¿No tienes cuenta? <Link to="/register"
                                    className="text-blue-700 hover:underline dark:text-blue-500"> Registrate</Link>
                            </div>
                        </form>
                    </div>
                </div>
