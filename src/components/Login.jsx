              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    Escriba aqui su dirección de correo electrónico y le
    ...
    sendPasswordResetEmail(auth, email)
      ...
      .catch((error) => {
        if (error.code === "auth/invalid-email") {
          ...
          setError(
            "Ocurrió un error al enviar el correo electrónico. " + error
          );
          closeModal();
        }
      });
        ...
        <div className="bg-white dark:bg-gray-800 w-full max-w-md shadow-md rounded-lg border border-gray-200 py-2">
          <div className="md:flex">
            <div className="w-full p-4 py-5">
              <h2
                className="text-center text-2xl font-bold t dark:text-white"
                style={{
                    ...
                    <div className="relative mb-6">
                      ...
                      <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                        <svg
                          ...
                          className="w-5 h-5 text-gray-500 dark:text-gray-400"
                        >
                          <path d="M10 2a4 4 0 0 1 4 4v2h2a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-6a2 2 0 0 1 2-2h2V6a4 4 0 0 1 4-4zm0 2a2 2 0 0 0-2 2v2h4V6a2 2 0 0 0-2-2z" />
                        </svg>
                      </div>
                      <div
