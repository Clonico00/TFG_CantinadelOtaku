        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            ...
            >
              ...
              <span className="font-extrabold tracking-tight hidden sm:block text-2xl md:text-md whitespace-nowrap">
                Cantina del Otaku{" "}
              </span>
            </Link>
          </div>
          <div className="hidden md:block">
            <div
              className={`${
                userAtom && userAtom.isAdmin === true ? "pr-20 mr-20" : ""
              } ml-10 flex items-baseline space-x-4 tracking-tight flex-grow-1 menu-item `}
            >
            ...
            <div className={`flex items-center relative `}>
              ...
              {isMenuOpen && (
                <div
                  className={`${
                    !userAtom ? "mt-5" : "mt-6"
                  } absolute z-10 bg-white rounded-md shadow-xl flex flex-col `}
                  style={{
                  ...
                  <div className="relative flex-grow">
                    ...
                    {isFocused &&
                      ...
                      filteredArticles.length > 0 && (
                        ...
                        >
                          <ul
                            className="absolute z-10 mt-2 py-2 w-full bg-white rounded-md shadow-lg max-h-48 overflow-y-auto"
