...
function Inicio() {
    ...
    return (
        <div>
            ...
            >
                <div className="flex flex-col ml-6  relative items-left px-8"
                    style={{ top: '25%' }}>
                    <h1 className="text-4xl md:text-7xl  font-extrabold drop-shadow-lg" style={{ color: '#232533' }}>
                        Libera al <span style={{ color: '#3a63f2' }}>superhéroe</span> <br />que llevas dentro.
                    </h1>
                    <p className="text-lg md:text-2xl text-black mt-4 text-left" style={{ color: '' }}>
