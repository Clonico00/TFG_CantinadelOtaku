      ...
      if (currentUser) {
        try {
          ...
          if (!snapshot.empty) {
            ...
            const image =
              userData && userData.image ? userData.image : UsuarioIconDefault;
            setImage(image);
          }
        } catch (error) {
  ...
  return (
    <div className="flex justify-center">
      <div className="container mx-auto p-4 mt-10">
        ...
        />
        <div className="custom-max-height overflow-auto bg-white dark:bg-gray-800 shadow-md rounded-lg border border-gray-200 max-w-7xl mb-28 mt-12">
              ...
              >
                <div className="flex flex-col">
                  ...
                  <div className="text mt-2">
                    ...
                    <span
                      className="date text-sm text-gray-500 flex items-center mt-1"
